  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="container bg-white m-4 p-12 w-500 text-center rounded-md shadow-lg max-w-full mx-auto">
        ...
        <h1 className='text-3xl mb-8 font-bold text-gray-900'>Twink</h1>
        <h5 className='text-1xl font-bold p-0 text-gray-500'>Добро пожаловать в чат</h5>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className="text-left text-gray-400 text-sm">У вас еще нет учетной записи? Это норамально</p>
        </form>
      </div>
    </div>
  )
